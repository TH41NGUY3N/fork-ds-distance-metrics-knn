...
In this repository, we practice different distance metrics in Python and have a look at the k-nearest neighbors algorithm.
...
The third notebook will show you how to implement KNN with sklearn, while you can try this by yourself directly in the fourth notebook. In the fifth notebook, you have the chance to create your own KNN algorithm!
